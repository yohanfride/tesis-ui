        ...
        <div class="panel">
          <div class="panel-body">
            <div class="brand">
              ...
              <h2 class="brand-text font-size-18">Forgot Password</h2>
            </div>
            <form method="post" action="">
                ...
                <?php } if($success){ ?>
                    <div class="alert dark alert-alt alert-success alert-dismissible text-left" role="alert">
	                    ...
	                    Success<br/><span class="alert-link">Request reset password success, check your email for next step </span>.
	                </div>
                <?php } ?>
