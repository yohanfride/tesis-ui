            ...
            <form method="get" autocomplete="off">
              <div class="row">
                <div class="form-group form-material col-8" id="selectGroup">
                  <label class="form-control-label" for="inputSelectGroup">Filter Master Devices Type</label>
                  <select class="form-control " id="inputSelectGroup" name="type">
                      ...
                      <option value="allgroup" <?= ($type == 'allgroup')?'selected':'' ?> >All Group</option>
                      <?php foreach ($group as $d) { ?>
                      <option value="<?= $d->group_code; ?>" <?= ($type == $d->group_code)?'selected':'' ?> ><?= $d->name?></option>
                      <?php } ?>
                  </select>
                </div>
